...
const Jumpstart = () => {
    return (
        <section className="relative min-h-[150vh] w-full bg-[#502274] text-white overflow-hidden pt-24 pb-12">
            ...
            />
            <img src={purple} alt=" purple" className='absolute bottom-130 right-[4%] w-[22%]  z-0' />
            ...
            <div className="flags">
                <div className="grid grid-cols-2 w-[15%] mx-auto py-18">
                    <img src={flag1} alt=" flag 1" width={100} className='' />
                    <img src={flag2} alt=" flag 2" width={100} className='' />
                </div>
            </div>
