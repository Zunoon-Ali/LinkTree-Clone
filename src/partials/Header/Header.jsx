...
import logo from "../../images/linktree-logo.svg";
import rightImg1 from "../../images/img1.jpg";
import rightImg2 from "../../images/img2.jpg";
...
const Header = () => {
  ...
  return (
    <header className="fixed top-15 left-0 w-full z-50">
      <nav
        className={`navbar flex items-center justify-between w-[80vw] mx-auto bg-gray-100 px-12 py-6 rounded-full transition-transform duration-300 ${
          showHeader ? "translate-y-0" : "-translate-y-32"
        }`}
      >
        <div className="flex items-center gap-8">
          <Link to="/">
            <img src={logo} alt="Linktree Logo" className="w-36" />
          </Link>
        ...
        <div className="flex gap-4">
          <button className="bg-gray-200 px-5 py-3 rounded-xl">Login</button>
          <button className="bg-slate-800 text-white px-5 py-3 rounded-xl">
            Sign up for free
          </button>
        </div>
      </nav>
